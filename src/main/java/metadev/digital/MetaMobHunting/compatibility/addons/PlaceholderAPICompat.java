...
public class PlaceholderAPICompat implements IMobHuntCompat, IFeatureHolder {
    ...
    private static String sMin, sMax, pMin = "2.11.6", pMax;
	...
	public PlaceholderAPICompat() {
        compatPlugin = Bukkit.getPluginManager().getPlugin(SupportedPluginEntities.PlaceholderAPI.getName());
    ...
    public void registerFeatures() {
        ...
        // Base plugin
        enabled = MobHunting.getInstance().getConfigManager().enableIntegrationPlaceholderAPI;
