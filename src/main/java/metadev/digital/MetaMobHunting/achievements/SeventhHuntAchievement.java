...
public class SeventhHuntAchievement implements ProgressAchievement {
	...
	public String getName() {
		return plugin.getMessages().getString("achievements.hunter.7.name", "mob", mExtendedMob.getLocalizedName());
	}
	...
	public ItemStack getSymbol() {
		return mExtendedMob.getInventoryAchivementItem(mExtendedMob.getMobName(), 7, 0);
	}
